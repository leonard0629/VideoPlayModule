...
import com.jiuguo.app.db.VideoDBHelper;
...
public class VideoDBManager {
	 ...
	 * @param videoLoad
	 */
	public void addVideoLoad(VideoLoad videoLoad) throws SQLException {
		database.beginTransaction();
		try {
            database.execSQL("insert into video(videoid,title,describe,duration,postdate,"
